    	...
    	<?php $this->widget('application.extensions.mbmenu.MbMenu',array(
            'items'=>array(
                ...
                array('label'=>'Chamados',
                  'items'=>array(
                    array('label'=>'Gerenciar', 'url'=>array('/chamado/admin'), 'visible'=>!Yii::app()->user->isGuest),
                    array('label'=>'Novo', 'url'=>array('/chamado/create')),
                    array('label'=>'Relatórios',
                  		'items'=>array(
                        array('label'=>'Realizados', 'url'=>array('/chamado/resSearchporChamadosRealizados/')),
                        array('label'=>'Em Aberto', 'url'=>array('/chamado/resSearchporChamadosEmAberto/')),
                    		array('label'=>'Tela Cheia', 'url'=>array('/chamado/visualizarTelaCheia/'))
                  		),
                  	'visible'=>!Yii::app()->user->isGuest
                	),
                  ),
